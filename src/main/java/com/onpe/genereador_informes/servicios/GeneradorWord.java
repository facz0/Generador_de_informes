...
public class GeneradorWord {
    ...
    public void generarDocumento(Contrato contrato, String rutaPlantilla, String rutaSalida){
        try{
            ...
            String area = contrato.getPersonal().getGerencia() != null
                ? contrato.getPersonal().getGerencia().getNombreGerencia()
                : contrato.getPersonal().getCargoArea().getArea().getNombreArea();
