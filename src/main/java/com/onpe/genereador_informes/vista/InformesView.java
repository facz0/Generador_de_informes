...
public class InformesView {
    ...
    public void mostrar() {
        ...
        btnGenerar.setOnAction(e -> {
            ...
            if (controlador.generarInformesSeleccionados(seleccionados))
                DashboardView.mostrarAlerta("✅ Informes generados", seleccionados.size() + " informes generados correctamente.");
        });
